...
export default function App() {
  return <SiteLayout><ScrollManager /><Suspense fallback={<LoadingScreen />}><Routes><Route path="/" element={<Home />} /><Route path="/flights" element={<FlightsPage />} /><Route path="/hotels" element={<HotelsPage />} /><Route path="/hotels/:id" element={<HotelDetailPage />} /><Route path="/destinations" element={<DestinationsPage />} /><Route path="/destinations/:id" element={<DestinationDetailPage />} /><Route path="/experiences" element={<ExperiencesPage />} /><Route path="/deals" element={<PackagesPage />} /><Route path="/transport" element={<TransportPage />} /><Route path="/trips" element={<TripsPage />} /><Route path="/dashboard" element={<DashboardPage />} /><Route path="/admin" element={<AdminPage />} /><Route path="/ticket/:id" element={<TicketPage chrome="false" />} /><Route path="/checkout" element={<PaymentPage />} /><Route path="/login" element={<AuthPage mode="login" chrome="false" />} /><Route path="/signup" element={<AuthPage mode="signup" chrome="false" />} /><Route path="/guide" element={<GuidePage />} /><Route path="/blog" element={<BlogPage />} /><Route path="/about" element={<AboutPage />} /><Route path="/support" element={<SupportPage />} /><Route path="/legal" element={<LegalPage />} /><Route path="*" element={<NotFound />} /></Routes></Suspense></SiteLayout>
}
